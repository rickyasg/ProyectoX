...
{
    [HubName("MarcadorBadmintonHub")]
    public class MarcadorBadmintonHub : Hub
    {
        ...
        {
            string[] pantallas = _groups.GetConnections("badminton").ToArray();
            string[] names = _groups.GetConnections("remotoBadminton").ToArray();
        ...
        public override Task OnDisconnected(bool stopCalled)
        {
            ...
            controlPantalla("sq", "grupoBadminton");
