...
{
    [HubName("MarcadorPelotaVascaHub")]
    public class MarcadorPelotaVascaHub : Hub
    {
        ...
        {
            string[] pantallas = _groups.GetConnections("pelotaVasca").ToArray();
            string[] names = _groups.GetConnections("remotopelotaVasca").ToArray();
        ...
        public override Task OnDisconnected(bool stopCalled)
        {
            ...
            controlPantalla("sq", "grupoPelotaVasca");
