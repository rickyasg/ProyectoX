...
{
    public class AcreditacionCredencial
    {
        ...
        public AcreditacionCredencial(DataTable datosPersonales, DataTable datosPrivilegios, string pathResources)
        {
...
public struct PrivilegioReporte
{
    public string Descripcion { get; set; }
    public TipoPrivilego Tipo;
    public int Posicion { get; set; }
    public string Privilegio { get; set; }
    public int Orden { get; set; }

    public PrivilegioReporte(int posicion, string descripcion, string privilegio, TipoPrivilego tipo, int orden)
    {
